  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-24 max-w-4xl">
        <h1 className="text-4xl font-bold text-gray-900 mb-8 pt-8">Terms &amp; Conditions</h1>

        <p className="text-gray-700 mb-4">
          These terms and conditions apply to the Restro360 app for mobile devices and web browsers, together with any related services operated by Engispider (collectively, the &quot;Application&quot;). Engispider is hereby referred to as the &quot;Service Provider&quot;.
        </p>
        ...
        <Section title="User-Generated Content and Acceptable Use">
          <p className="text-gray-700 mb-3">If this Application allows users to post, share, or upload content, you agree not to post content that:</p>
          ...
          <p className="text-gray-700 mb-3">The Service Provider reserves the right to:</p>
          <ul className="list-disc list-inside text-gray-700 space-y-1 mb-6">
          ...
          <p className="text-gray-700 mb-4">
            If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at{' '}
            <a href="mailto:support@engispider.com" className="text-blue-600 hover:underline">support@engispider.com</a>.
            {' '}The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at{' '}
            <a href="mailto:support@engispider.com" className="text-blue-600 hover:underline">support@engispider.com</a>
            {' '}to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
          </p>
          <p className="text-gray-700">
        ...
        <ul className="list-disc list-inside space-y-1 mb-8">
          ...
          <li>
            <a href="https://firebase.google.com/terms/crashlytics" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
        ...
        <Section title="Limitation of Liability">
          ...
          <p className="text-gray-700 mb-3">However, the Service Provider retains full liability for:</p>
        ...
        <Section title="DSA Compliance (Digital Services Act)">
          ...
          <p className="text-gray-700 mb-4">
            <strong>Point of Contact:</strong> The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at{' '}
            <a href="mailto:support@engispider.com" className="text-blue-600 hover:underline">support@engispider.com</a>.
          ...
          <p className="text-gray-700 mb-4">
            <strong>Content Moderation and Statement of Reasons:</strong> When the Service Provider restricts access to content, suspends or terminates an account, or otherwise limits the availability of the Application&apos;s features, a clear and specific statement of reasons will be provided to the affected user. The statement will include the nature of the restriction, the legal or contractual basis for the decision, and information on available redress mechanisms, in accordance with Article 17 of the DSA.
          </p>
          <p className="text-gray-700 mb-4">
            <strong>Notice and Action:</strong> Users and third parties may submit notices of allegedly illegal content through the contact details provided in these Terms. The Service Provider will process notices promptly, diligently, and without automated decision-making where the circumstances require human review. Notices will be acknowledged electronically and a decision communicated without undue delay, in accordance with Article 16 of the DSA.
          </p>
          <p className="text-gray-700 mb-4">
            <strong>Out-of-Court Dispute Settlement:</strong> Disputes regarding content moderation decisions, including decisions to restrict content or suspend accounts, may be submitted to an out-of-court dispute settlement body certified in accordance with Article 21 of the DSA. The Service Provider will engage with such bodies in good faith. Use of out-of-court dispute settlement does not affect your right to seek judicial remedy under applicable law.
          </p>
          <p className="text-gray-700 mb-4">
            <strong>Transparency Reporting:</strong> The Service Provider publishes periodic transparency reports covering content moderation activities, including the volume of notices received, actions taken, and automated means used, in accordance with Article 24 of the DSA. Reports are made available upon request at{' '}
            <a href="mailto:support@engispider.com" className="text-blue-600 hover:underline">support@engispider.com</a>.
          </p>
          <p className="text-gray-700">
        ...
        <Section title="Changes to These Terms and Conditions">
          ...
          <p className="text-gray-700">
            Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at{' '}
            <a href="mailto:support@engispider.com" className="text-blue-600 hover:underline">support@engispider.com</a>.
          </p>
        </Section>

        <p className="text-gray-700 mb-8">These terms and conditions are effective as of 2026-06-03</p>
